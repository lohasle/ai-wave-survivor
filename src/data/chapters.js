...
export const Chapter6Data = {
  id: 'chapter6',
  title: '第六章：被陷害与领悟',
  description: '职场沉浮之后，你终于开始重新定义自己的价值。',
  timeline: '2027年2-4月',
  scenes: [
    {
      id: 'chapter6-intro',
      title: '最低谷',
      type: 'story',
      content: `2027年2月，你被调到了边缘岗位。

没有项目，没有团队，每天只剩重复的流程性工作。

你第一次认真思考：

如果“效率”可以被AI无限放大，人类到底还剩下什么？`,
      choices: [
        {
          text: '先稳住心态，继续观察',
          nextScene: 'chapter6-awakening',
          effect: { stress: -10 }
        },
        {
          text: '主动复盘一路走来的得失',
    ...
    {
      id: 'chapter6-awakening',
      title: '领悟',
      type: 'story',
      content: `你终于明白，真正不可替代的不是“会不会用工具”，

而是你如何理解人、连接人，并在不确定中做出判断。

AI可以放大能力，但无法替代你的价值观与选择。`,
      choices: [
        {
          text: '完成当前版本（暂告一段落）',
...
export function findSceneById(chapterId, sceneId) {
  ...
  return chapter.scenes.find(scene => scene.id === sceneId) || null
}
